 ...
 */
final class Version20210308105650 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE feedback_value (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, value SMALLINT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE insight (id INT AUTO_INCREMENT NOT NULL, feedback_id INT NOT NULL, feature_id INT NOT NULL, value_id INT NOT NULL, INDEX IDX_FE3413DBD249A887 (feedback_id), INDEX IDX_FE3413DB60E4B879 (feature_id), INDEX IDX_FE3413DBF920BBA2 (value_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE insight ADD CONSTRAINT FK_FE3413DBF920BBA2 FOREIGN KEY (value_id) REFERENCES feedback_value (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE insight DROP FOREIGN KEY FK_FE3413DBF920BBA2');
        ...
        $this->addSql('DROP TABLE feedback_value');
